...
my_planner = ActionPlanningAgent(openai_api_key, knowledge)
# TODO: 4 - Print the agent's response to the following prompt: "One morning I wanted to have scrambled eggs"
egg_steps = my_planner.extract_steps_from_prompt("One morning I wanted to have scrambled eggs")
print("Prompt: One morning I wanted to have scrambled eggs")
print(egg_steps)