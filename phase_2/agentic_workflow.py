...
with open("Product-Spec-Email-Router.txt", "r") as my_file:
    product_spec = my_file.read()
...
routing_agent.agents = [
    ...
    },
    {
        ...
        "description": "Responsible for defining product features only",
        "func": lambda x: program_manager_support_function(x)
    },
    {
        "name": "Development Engineer",
        "description": "Responsible for defining development tasks only",
...
def product_manager_support_function(query):
    pm_response = product_manager_knowledge_agent.respond(query)
    pm_result = product_manager_evaluation_agent.evaluate(pm_response)
    return pm_result["final_response"]

def program_manager_support_function(query):
    pgm_response = program_manager_knowledge_agent.respond(query)
    pgm_result = program_manager_evaluation_agent.evaluate(pgm_response)
    return pgm_result["final_response"]

def dev_engineer_support_function(query):
    dev_response = development_engineer_knowledge_agent.respond(query)
    dev_result = development_engineer_evaluation_agent.evaluate(dev_response)
    return dev_result["final_response"]
# Run the workflow

print("\n*** Workflow execution started ***\n")
# Workflow Prompt
# ****
workflow_prompt = "Create a full development plan for this product including user stories, product features, and development tasks."
# ****
